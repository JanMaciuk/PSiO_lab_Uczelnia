...
public class WyszukiwanieMenu {
    protected static JFrame mainFrame = new JFrame("Wyszukiwanie");
    ...
    public static void wyszukajNaukowca() {
        System.out.println("Wyszukiwanie naukowca");
        defaultDisplay();
    ...
    public static void wyszukajAdministratora() {
        System.out.println("Wyszukiwanie administratora");
        defaultDisplay();
    ...
    public static void wyszukajStudenta() {
        ArrayList<Student> wynik = new ArrayList<>();
        System.out.println("Wyszukiwanie studenta");
        defaultDisplay();
        JButton imie = new JButton("Wyszukaj po imieniu");
        mainFrame.getContentPane().add(imie);
        imie.addActionListener(e -> {
    ...
    public static void wyszukajKurs() {
        System.out.println("Wyszukiwanie kursu");
        defaultDisplay();
    ...
    public static void wyswietlWszystko() {
        System.out.println("Wyświetlanie wszystkiego");
        DisplayArray.displayAll();
    }
}
